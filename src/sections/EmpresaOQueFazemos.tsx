...
const fases = [
  {
    n: "01",
    titulo: "Diagnóstico",
    subtitulo: "Onde a sua venda trava",
    desc: "Mapeamos a operação comercial de ponta a ponta: o que o número diz, onde os negócios travam, como o time está sendo gerido, o que está funcionando e o que está consumindo energia sem resultado.",
    entrega: "Documento escrito com o mapa completo e as prioridades na ordem certa.",
    destaque: false,
  },
  {
    n: "02",
    titulo: "Estruturação",
    subtitulo: "Como a venda deve ser montada",
    desc: "Desenhamos o processo comercial que a sua operação precisa: etapas definidas, critérios de avanço, métricas que guiam decisão — adaptado ao que você já tem, sem recomeçar do zero.",
    entrega: "Playbook comercial que o time consegue executar sem depender de improvisos.",
    destaque: true,
  },
  {
    n: "03",
    titulo: "Operação",
    subtitulo: "Fazer o processo rodar de verdade",
    desc: "Trabalhamos dentro da sua operação até o processo estar instalado e funcionando. Não entregamos um documento e sumimos. Ficamos até o resultado aparecer nos números.",
    entrega: "Uma máquina de venda previsível — que funciona independente de quem está na cadeira.",
    destaque: false,
  },
];
